-- Actualiza la RPC public.hacer_puja para:
-- 1) Usar reglas de incremento por caballo (remate_price_rules.horse_id)
--    - Si hay reglas para el caballo, se priorizan sobre reglas "default" (horse_id null)
-- 2) Mantener "Ponerle" (auto) = minimo permitido
-- 3) En manual, exigir al menos (minimo_auto + 10)
